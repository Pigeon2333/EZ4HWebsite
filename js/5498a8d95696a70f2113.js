...
function(e) {
	function r(data) {
		for (var r, n, l = data[0], f = data[1], d = data[2], i = 0, h = []; i < l.length; i++) n = l[i],
	...
	l.e = function(e) {
		...
		if (0 !== t) if (t) r.push(t[2]);
			...
			script.src = function(e) {
				return l.p + "" + {
					2 : "09457b78c3773b4a1d88",
					3 : "2e87c6018483cc0b5b69",
					4 : "cf449784478844dc0674",
					5 : "33a21d402cc27637243b"
				} [e] + ".js"
			} (e);
			var f = new Error;
			c = function(r) {
	...
	l.t = function(e, r) {
		...
		if (l.r(t), Object.defineProperty(t, "default", {
			enumerable: !0,
			value: e
		}), 2 & r && "string" != typeof e) for (var n in e) l.d(t, n,
		function(r) {
			return e[r]
		}.bind(null, n));
		return t
